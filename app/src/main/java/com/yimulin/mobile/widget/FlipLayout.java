...
public class FlipLayout extends FrameLayout {
    ...
    private final Paint mminutenePaint = new Paint();
...
//        }
    ...
    private void initTextView() {
        ...
        runOnUiThread(() -> mInvisibleTextView.setText(finalValue));
    }
