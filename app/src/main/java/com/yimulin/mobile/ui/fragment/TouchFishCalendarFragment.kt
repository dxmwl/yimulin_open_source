...
//
///**
// * @ClassName: TouchFishCalendarFragment
// * @Description:
// * @Author: 常利兵
// * @Date: 2024/1/17 0017 14:53
// **/
//class TouchFishCalendarFragment : AppFragment<AppActivity>() {
//
...
//    }
//
//    private fun getFishingCalendar() {
//        EasyHttp.get(this)
//            .api(GetFishingCalendarApi())
//            .request(object : HttpCallback<HttpData<String>>(this) {
//                override fun onSucceed(result: HttpData<String>?) {
//                    iv_result?.let {
//                        Glide.with(this@TouchFishCalendarFragment)
//                            .load(result?.getData())
//                            .into(it)
//                    }
//                }
