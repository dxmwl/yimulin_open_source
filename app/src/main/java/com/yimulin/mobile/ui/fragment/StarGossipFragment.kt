...
import com.yimulin.mobile.http.api.GetStarGossipApi
...
/**
 * @ClassName: StarGossipFragment
 * @Description:
 * @Author: 常利兵
 * @Date: 2024/1/17 0017 15:13
 **/
class StarGossipFragment : AppFragment<AppActivity>() {
