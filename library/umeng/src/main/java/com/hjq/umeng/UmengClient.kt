...
object UmengClient {
     ...
     * 初始化友盟相关 SDK
     */
    fun init(application: Application?, logEnable: Boolean,channel: String? = "guanfang") {
     ...
     */
    fun preInit(application: Application?, logEnable: Boolean,channel: String? = "guanfang") {
